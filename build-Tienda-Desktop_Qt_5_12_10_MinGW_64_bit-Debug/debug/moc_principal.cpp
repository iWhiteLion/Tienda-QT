...
#include "../../../../Documents/P58-Qt-Tienda-main/P58-Qt-Tienda-main/principal.h"
...
QT_MOC_LITERAL(1, 10, 22), // "on_cmdAgregar_released"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 33), // "on_inProducto_currentIndexCha..."
QT_MOC_LITERAL(4, 68, 5), // "index"
QT_MOC_LITERAL(5, 74, 22) // "on_cmdFacturar_clicked"

    },
    "Principal\0on_cmdAgregar_released\0\0"
    "on_inProducto_currentIndexChanged\0"
    "index\0on_cmdFacturar_clicked"
};
...
void Principal::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_cmdAgregar_released(); break;
        case 1: _t->on_inProducto_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_cmdFacturar_clicked(); break;
        default: ;
        }
    }
}
